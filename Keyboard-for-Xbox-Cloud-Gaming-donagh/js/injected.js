...
exports.secondClickText = 'Click again to enable the mouse';
...
function Toolbar() {
    ...
    return preset.preset ? (react_1.default.createElement("div", { className: (0, classnames_1.default)(mouse.status === 'listening' && 'mouse-listening-xmnk', 'full-width-xmnk') },
        react_1.default.createElement("div", { className: (0, classnames_1.default)('header-xmnk', `header-xmnk-${isExpanded ? 'expanded' : 'minimized'}`, 'full-width-xmnk') },
            ...
            showControlsOverlay || (!isExpanded && presetHasMouseControls) ? (react_1.default.createElement("div", { className: "size-buttons-xmnk" }, isExpanded ? (react_1.default.createElement("button", { onClick: decreaseSize, title: "Show less" }, "-")) : (react_1.default.createElement("button", { onClick: increaseSize, title: "Mostrar más" }, "+")))) : null),
