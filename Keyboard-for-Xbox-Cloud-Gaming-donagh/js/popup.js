...
function GamepadConfigSelector({ className, currentConfig, activeConfig, isEnabled, isPaid, allConfigs, setCurrentConfig, addNewConfig, importConfig, openPaymentPage, toggleShowSettings, }) {
    ...
    return isNew ? (react_1.default.createElement("div", { className: rootCssClasses },
        ...
        react_1.default.createElement("div", { className: "horizontal" },
            ...
            react_1.default.createElement(react_2.IconButton, { onClick: toggleShowSettings, title: "Ajustes", ariaLabel: "Ajustes" },
    ...
    return (react_2.default.createElement("div", null,
        react_2.default.createElement("div", { className: "global-prefs-body" },
            react_2.default.createElement("section", null,
                react_2.default.createElement("h3", null, "Preference"),
                react_2.default.createElement(react_1.Checkbox, { label: "Show overlay shortcut control", checked: prefs.showControlsOverlay, onChange: handleChange, title: "Show an overlay with all button bindings visible during gameplay" })),
    ...
    return (react_1.default.createElement(react_2.ThemeProvider, { theme: theme_1.fluentXboxHeaderTheme },
        react_1.default.createElement("header", { className: "box horizontal green-bg space-between setup-details" },
            react_1.default.createElement("div", { className: "logo unselectable horizontal centered-v" },
                ...
                react_1.default.createElement(react_2.Toggle, { title: `${isEnabled ? 'Disable' : 'enable'} mouse y teclado`, checked: isEnabled, onChange: handleToggle, className: "no-margin margin-left" }),
                /* Crear el botón justo aquí */
                react_1.default.createElement("img", { 
                    src: "../fortnite.png", 
                    onClick: () => {window.open('https://www.xbox.com/en-ie/play/games/fortnite/BT5P2X999VH2')}, 
            ...
            react_1.default.createElement("div", { className: "horizontal centered" },
                react_1.default.createElement("div", { className: "vertical centered-v left-aligned margin-right" },
                    react_1.default.createElement("div", { className: "overflow-ellipsis" },
                        react_1.default.createElement("small", null, "Playing with:"),
                        " ",
...
function Logo({ isEnabled }) {
    ...
    return (react_1.default.createElement("div", { className: "logo unselectable horizontal centered-v" },
        react_1.default.createElement("img", { src: "/images/fvitu.png", style: Object.assign(Object.assign({}, imgStyle), opacity), className: "margin-right-s"})));
}
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        isOpen ? (react_1.default.createElement(react_2.Callout, { setInitialFocus: true, gapSpace: 0, directionalHint: react_2.DirectionalHint.bottomRightEdge, target: `#${buttonId}`, onDismiss: handleClose, 
            ...
            react_1.default.createElement("div", { style: { width: 275 }, className: "padding-full" },
                react_1.default.createElement(react_2.TextField, { placeholder: "Name of the new preset", autoFocus: isOpen, value: name, maxLength: 18, onKeyPress: handleKeyPress, onChange: (e) => setName(e.currentTarget.value) }),
...
function SensitivitySelector({ dispatch, disabled, readOnly, sensitivity }) {
    ...
    return (react_1.default.createElement("div", null,
        react_1.default.createElement(react_2.SpinButton, { label: "Mouse sensitivity (1-99)", className: (0, classnames_1.default)(readOnly && 'no-pointer-events'), labelPosition: react_2.Position.top, disabled: disabled, onChange: readOnly ? undefined : handleChange, value: disabled ? 'N/A' : (100 - sensitivity).toString(), min: 1, max: 99 }),
        react_1.default.createElement("small", null, "You may need to set the sensitivity in the game settings as well (as well as turn off any \"deadzone\" options in the game).")));
}
...
function ShortcutCommandsList() {
    ...
    return (react_2.default.createElement("section", null,
        react_2.default.createElement("h3", null, "Atajos"),
...
function StickSelector({ disabled, stick, onChange, readOnly }) {
    ...
    return (react_1.default.createElement(react_2.ChoiceGroup, { className: (0, classnames_1.default)(readOnly && 'no-pointer-events'), disabled: disabled, label: "Which analog stick will move the mouse movement?", selectedKey: stick === 0 ? '0' : stick === 1 ? '1' : '-1', onChange: readOnly ? undefined : handleChange, options: options }));
}
